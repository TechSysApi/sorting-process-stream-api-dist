var variables={
  ...
  "version": "0.40.0-feature-PZS-7630-add-sort-reason-sender-order-inspection.1",
  ...
  "license": "Apache-2.0",
  "dependencies": {
    "@ch-post-logistics/sorting-process-assignment-stream-api": "0.37.0-feature-PZS-7630-add-sort-reason-sender-order-inspection.3",
    "@ch-post-logistics/sorting-process-submission-stream-api": "0.10.1",
    "@ch-post-logistics/sorting-process-discharge-stream-api": "0.11.1",
    "@ch-post-logistics/sorting-process-coding-stream-api": "5.2.0"
  },
  "devDependencies": {
