var variables={
  ...
  "version": "1.4.1-feature-update-jenkins-config.1",
  ...
  "license": "Apache-2.0",
  "dependencies": {
    "@ch-post-logistics/sorting-process-assignment-stream-api": "1.4.0",
    "@ch-post-logistics/sorting-process-submission-stream-api": "1.1.0",
    "@ch-post-logistics/sorting-process-discharge-stream-api": "1.1.0",
    "@ch-post-logistics/sorting-process-coding-stream-api": "5.9.0"
  },
  "devDependencies": {
    "apikana": "0.9.34",
