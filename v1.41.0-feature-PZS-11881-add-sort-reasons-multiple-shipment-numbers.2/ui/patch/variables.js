var variables={
  ...
  "version": "1.41.0-feature-PZS-11881-add-sort-reasons-multiple-shipment-numbers.2",
  ...
  "license": "Apache-2.0",
  "dependencies": {
    "@ch-post-logistics/sorting-process-assignment-stream-api": "1.30.0-feature-multiple-shipment-numbers.2",
    "@ch-post-logistics/sorting-process-submission-stream-api": "2.1.0",
    "@ch-post-logistics/sorting-process-discharge-stream-api": "1.5.0",
    "@ch-post-logistics/sorting-process-coding-stream-api": "5.20.0"
  },
  "devDependencies": {
    "apikana": "0.9.34",
